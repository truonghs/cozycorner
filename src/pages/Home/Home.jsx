...
export default function Home() {
  return (
    <div className="h-screen scrollbar-thin scrollbar-thumb scrollbar-track">
      <div>
        <Carousel
          opts={{
            loop: true,
            ...
            <CarouselContent className="desktop:w-desktop pl-2 w-screen">
              <CarouselItem className="laptop:basis-1/3 desktop:basis-1/4 tablet:basis-1/2 pl-0 mobile:basis-1/2 basis-1/1 pl-2">
                <div className="flex justify-between items-center select-none w-full gap-2  bg-off-white shadow-sm shadow-black/20 py-1 px-2 rounded-md my-1">
                  <TbPackageExport className="text-5xl text-yellow" />
              ...
              <CarouselItem className="laptop:basis-1/3 desktop:basis-1/4 tablet:basis-1/2 pl-0 mobile:basis-1/2 basis-1/1 pl-2">
                <div className="flex justify-between items-center select-none w-full gap-2  bg-off-white shadow-sm shadow-black/20 py-1 px-2 rounded-md my-1">
                  <RiRefund2Line className="text-5xl text-yellow" />
                  <div className="w-full">
              ...
              <CarouselItem className="laptop:basis-1/3 desktop:basis-1/4 tablet:basis-1/2 pl-0 mobile:basis-1/2 basis-1/1 pl-2">
                <div className="flex justify-between items-center select-none w-full gap-2  bg-off-white shadow-sm shadow-black/20 py-1 px-2 rounded-md my-1">
                  <RiCustomerService2Fill className="text-5xl text-yellow" />
                  <div className="w-full">
              ...
              <CarouselItem className="laptop:basis-1/3 desktop:basis-1/4 tablet:basis-1/2 pl-0 mobile:basis-1/2 basis-1/1 pl-2">
                <div className="flex justify-between items-center select-none w-full gap-2  bg-off-white shadow-sm shadow-black/20 py-1 px-2 rounded-md my-1">
                  <RiBankLine className="text-5xl text-yellow" />
                  <div className="w-full">
      ...
      <div className="flex items-center justify-center desktop:mt-14 laptop:mt-12 mobile:mt-8 mobile:mt-4 mt-2">
        <div className="desktop:max-w-[1200px] max-w-full flex justify-center items-center flex-col mobile:border-yellow mobile:border-[6px] rounded-md mobile:border-solid mobile:py-2 mobile:px-6 py-1 px-2 bg-off-white">
          <div className="font-dancing laptop:text-7xl text-4xl font-bold text-yellow-dark">Được mua nhiều nhất</div>
          <div className="mt-4">
